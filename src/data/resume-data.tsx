...
export const RESUME_DATA = {
  ...
  summary: `Product engineer with a focus on AI. Currently at Starlight, bringing automation to the public sector. Previously helped startups go from idea to production, shipped my own apps, led workshops, and taught software engineering.`,
